...
export interface accountsGenqlSelection{
    ...
    /** fetch data from the table: "addresses" */
    addresses?: (addressesGenqlSelection & { __args?: {
...
export interface accounts_bool_exp {_and?: (accounts_bool_exp[] | null),_not?: (accounts_bool_exp | null),_or?: (accounts_bool_exp[] | null),account_id?: (uuid_comparison_exp | null),addresses?: (addresses_bool_exp | null),username?: (String_comparison_exp | null)}


/** input type for inserting data into table "accounts" */
export interface accounts_insert_input {account_id?: (Scalars['uuid'] | null),username?: (Scalars['String'] | null)}
...
export interface accounts_on_conflict {constraint: accounts_constraint,update_columns: accounts_update_column[],where?: (accounts_bool_exp | null)}


/** Ordering options when selecting data from "accounts". */
export interface accounts_order_by {account_id?: (order_by | null),addresses_aggregate?: (addresses_aggregate_order_by | null),username?: (order_by | null)}


/** primary key columns input for table: accounts */
export interface accounts_pk_columns_input {account_id: Scalars['uuid']}


/** input type for updating data in table "accounts" */
export interface accounts_set_input {account_id?: (Scalars['uuid'] | null),username?: (Scalars['String'] | null)}
...
export interface addresses_aggregate_order_by {count?: (order_by | null),max?: (addresses_max_order_by | null),min?: (addresses_min_order_by | null)}


/** Boolean expression to filter rows from the table "addresses". All fields are combined with a logical 'AND'. */
export interface addresses_bool_exp {_and?: (addresses_bool_exp[] | null),_not?: (addresses_bool_exp | null),_or?: (addresses_bool_exp[] | null),account_id?: (uuid_comparison_exp | null),address?: (String_comparison_exp | null),network?: (String_comparison_exp | null)}


/** order by max() on columns of table "addresses" */
export interface addresses_max_order_by {account_id?: (order_by | null),address?: (order_by | null),network?: (order_by | null)}


/** order by min() on columns of table "addresses" */
export interface addresses_min_order_by {account_id?: (order_by | null),address?: (order_by | null),network?: (order_by | null)}


/** Ordering options when selecting data from "addresses". */
export interface addresses_order_by {account_id?: (order_by | null),address?: (order_by | null),network?: (order_by | null)}


/** mutation root */
export interface mutation_rootGenqlSelection{
    /** insert data into the table: "accounts" */
    insert_accounts?: (accounts_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: accounts_insert_input[], 
    /** upsert condition */
    on_conflict?: (accounts_on_conflict | null)} })
    /** insert a single row into the table: "accounts" */
    insert_accounts_one?: (accountsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: accounts_insert_input, 
    /** upsert condition */
    on_conflict?: (accounts_on_conflict | null)} })
    /** update data of the table: "accounts" */
    update_accounts?: (accounts_mutation_responseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (accounts_set_input | null), 
    /** filter the rows which have to be updated */
    where: accounts_bool_exp} })
    /** update single row of the table: "accounts" */
    update_accounts_by_pk?: (accountsGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (accounts_set_input | null), pk_columns: accounts_pk_columns_input} })
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface query_rootGenqlSelection{
    /** fetch data from the table: "accounts" */
    accounts?: (accountsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    where?: (addresses_bool_exp | null)} })
    /** fetch data from the table: "addresses" using primary key columns */
    addresses_by_pk?: (addressesGenqlSelection & { __args: {address: Scalars['String'], network: Scalars['String']} })
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export type SubscriptionGenqlSelection = subscription_rootGenqlSelection
    ...
    export const isaccounts_mutation_response = (obj?: { __typename?: any } | null): obj is accounts_mutation_response => {
